...
return {
  ...
  opts = {
    ...
    features = {
      large_buf = { size = 1024 * 512, lines = 50000 }, -- set global limits for large files for disabling features like treesitter
    ...
    mappings = {
      ...
      n = {
        ...
        ["<Leader>ue"] = { "<cmd>set relativenumber!<cr>", desc = "Toggle relative line numbers" },
